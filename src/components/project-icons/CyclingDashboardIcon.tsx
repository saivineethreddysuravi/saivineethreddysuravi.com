...
export default function CyclingDashboardIcon({ width = 800, height = 450 }: CyclingDashboardIconProps) {
  ...
  return (
    ...
    >
      <defs>
        <pattern id="cySmallGrid" width="10" height="10" patternUnits="userSpaceOnUse">
          <path d="M 10 0 L 0 0 L 0 10" fill="none" stroke="#2C2C3A" strokeWidth="0.5" />
        </pattern>
        <pattern id="cyGrid" width="100" height="100" patternUnits="userSpaceOnUse">
          <rect width="100" height="100" fill="url(#cySmallGrid)" />
          <path d="M 100 0 L 0 0 L 0 100" fill="none" stroke="#3A3A4C" strokeWidth="1" />
        </pattern>
        <linearGradient id="cyFrameGradient" x1="50" y1="30" x2="750" y2="420" gradientUnits="userSpaceOnUse">
      ...
      <motion.g initial={{ opacity: 0 }} whileInView={{ opacity: 0.1 }} transition={{ duration: 2 }}>
        <rect width="100%" height="100%" fill="url(#cyGrid)" />
      </motion.g>

      {/* Main Screen Frame */}
      <motion.rect
        x="50" y="30" width="700" height="390" rx="15"
        fill="url(#cyFrameGradient)"
        stroke="#4A4A6A"
        strokeWidth="2"
      ...
      <motion.g transform="translate(150, 120)" variants={gaugeSpin}>
        <circle r="60" stroke="#374151" strokeWidth="15" fill="none" />
        <motion.path d="M-60 0 A60 60 0 1 1 60 0" stroke="#10b981" strokeWidth="15" fill="none" strokeLinecap="round" variants={lineDraw} custom={0} />
        <text x="0" y="10" fontFamily="sans-serif" fontSize="24" fill="white" textAnchor="middle">85%</text>
      </motion.g>

      <motion.g transform="translate(400, 120)" variants={gaugeSpin} custom={0.1}>
        <circle r="60" stroke="#374151" strokeWidth="15" fill="none" />
        <motion.path d="M-60 0 A60 60 0 1 1 30 52" stroke="#3b82f6" strokeWidth="15" fill="none" strokeLinecap="round" variants={lineDraw} custom={0.1} />
        <text x="0" y="10" fontFamily="sans-serif" fontSize="24" fill="white" textAnchor="middle">12K</text>
      </motion.g>

      <motion.g transform="translate(650, 120)" variants={gaugeSpin} custom={0.2}>
        <circle r="60" stroke="#374151" strokeWidth="15" fill="none" />
        <motion.path d="M-60 0 A60 60 0 0 1 0 -60" stroke="#f59e0b" strokeWidth="15" fill="none" strokeLinecap="round" variants={lineDraw} custom={0.2} />
        <text x="0" y="10" fontFamily="sans-serif" fontSize="24" fill="white" textAnchor="middle">$4M</text>
      </motion.g>
      ...
      <g transform="translate(480, 220)">
        ...
        <text x="20" y="20" fontFamily="sans-serif" fontSize="12" fill="#9ca3af">Bikes</text>
        <motion.rect x="20" y="80" height="20" rx="4" fill="#3b82f6" initial="hidden" whileInView="visible" custom={1} variants={barGrow} />
        <text x="20" y="70" fontFamily="sans-serif" fontSize="12" fill="#9ca3af">Accessories</text>
        <motion.rect x="20" y="130" height="20" rx="4" fill="#f59e0b" initial="hidden" whileInView="visible" custom={2} variants={barGrow} />
        <text x="20" y="120" fontFamily="sans-serif" fontSize="12" fill="#9ca3af">Clothing</text>
      </g>
      
      {/* Dynamic Route Map */}
      <g transform="translate(50, 220)">
        <rect x="0" y="0" width="400" height="200" rx="8" fill="#1A1A2A" />
        <motion.path d="M 50 150 C 100 80, 200 200, 350 100" stroke="#60a5fa" strokeWidth="4" fill="none" variants={lineDraw} custom={0.3} />
