...
export default function SalesDashboardIcon({ width = 800, height = 450 }: SalesDashboardIconProps) {
  ...
  return (
    ...
    >
      <defs>
        <pattern id="sdSmallGrid" width="10" height="10" patternUnits="userSpaceOnUse">
          <path d="M 10 0 L 0 0 L 0 10" fill="none" stroke="#2C2C3A" strokeWidth="0.5" />
        </pattern>
        <pattern id="sdGrid" width="100" height="100" patternUnits="userSpaceOnUse">
          <rect width="100" height="100" fill="url(#sdSmallGrid)" />
          <path d="M 100 0 L 0 0 L 0 100" fill="none" stroke="#3A3A4C" strokeWidth="1" />
        </pattern>
        <linearGradient id="sdFrameGradient" x1="50" y1="30" x2="750" y2="420" gradientUnits="userSpaceOnUse">
      ...
      {/* Radial Sales Chart */}
      <motion.circle cx="200" cy="280" r="80" stroke="#FF00FF" strokeWidth="5" fill="none" variants={lineDraw} custom={0.5} />
      <motion.path
      ...
      <motion.text x="470" y="220" fontFamily="sans-serif" fontSize="18" fill="#E0E0E0" variants={dataStream} custom={0.8}>Growth Metrics</motion.text>
